#!/bin/bash
# Masaüstüne "STEP Görüntüleyici" kısayolu koyar. Bir kez çift tıklamanız yeterli.
...
SHORTCUT="$DESKTOP/STEP Görüntüleyici.command"
cat > "$SHORTCUT" <<INNER
#!/bin/bash
...
echo "      $SHORTCUT"
echo
echo "    Artık masaüstündeki \"STEP Görüntüleyici\" dosyasına çift tıklayarak"
