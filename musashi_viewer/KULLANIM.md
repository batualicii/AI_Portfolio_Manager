...
5 adet STEP dosyasını gerçek metal görünümüyle açar; parçaları fareyle tutup
birbirinden ayırmanı, **↺ Geri** ile hepsini ilk yerine döndürmeni sağlar.

Kurulum gerekmez: tarayıcıda çalışır, kütüphaneler klasörün içinde gömülüdür
